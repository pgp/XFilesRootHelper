...
// PGP's nameWindowToUnix2 impl
AString nameWindowToUnix2(LPCWSTR name)
{	
	// printf("Using nameWindowToUnix2 by PGP\n");
	return AString(wchar_to_UTF8(name).c_str());
}
// END PGP's nameWindowToUnix2 impl
