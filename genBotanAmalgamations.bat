...
python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x86 --os=linux --cc=clang --disable-avx2 --disable-aes-ni --disable-sha-ni
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_ANDROID_DIR%\x86

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=linux --cc=clang --disable-avx2 --disable-aes-ni --disable-sha-ni
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_ANDROID_DIR%\x86_64

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=armv7 --os=linux --cc=clang
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_ANDROID_DIR%\arm

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=aarch64 --os=linux --cc=clang
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_ANDROID_DIR%\arm64


REM ########## IOS

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --without-os-feature=thread_local --cpu=arm --os=ios --cc=clang
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_IOS_DIR%\arm

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=aarch64 --os=ios --cc=clang
...
python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=mingw --cc=gcc
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_DESKTOP_DIR%\windows\x86_64

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=linux --cc=gcc
...
python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=darwin --cc=gcc
move botan_all.cpp botan_all.h botan_all_internal.h %BOTAN_DEST_DESKTOP_DIR%\mac\x86_64

python configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=freebsd --cc=gcc
