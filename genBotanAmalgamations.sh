...
./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x86 --os=linux --cc=clang --disable-avx2 --disable-aes-ni --disable-sha-ni
mv botan_all.cpp botan_all.h botan_all_internal.h $BOTAN_DEST_ANDROID_DIR/x86

./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=linux --cc=clang --disable-avx2 --disable-aes-ni --disable-sha-ni
mv botan_all.cpp botan_all.h botan_all_internal.h $BOTAN_DEST_ANDROID_DIR/x86_64

./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=armv7 --os=linux --cc=clang
mv botan_all.cpp botan_all.h botan_all_internal.h $BOTAN_DEST_ANDROID_DIR/arm

./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=aarch64 --os=linux --cc=clang
...
./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=aarch64 --os=ios --cc=clang
...
./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=mingw --cc=gcc
mv botan_all.cpp botan_all.h botan_all_internal.h $BOTAN_DEST_DESKTOP_DIR/windows/x86_64

./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=linux --cc=gcc
...
./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=darwin --cc=gcc
mv botan_all.cpp botan_all.h botan_all_internal.h $BOTAN_DEST_DESKTOP_DIR/mac/x86_64

./configure.py --amalgamation --single-amalgamation-file --disable-modules=pkcs11 --disable-cc-tests --cpu=x64 --os=freebsd --cc=gcc
